...
# JWT configuration
JWT_SECRET_KEY = Config.JWT_SECRET_KEY if hasattr(Config, 'JWT_SECRET_KEY') else secrets.token_urlsafe(32)
JWT_ALGORITHM = "HS256"
    ...
    async def create_api_key(self, user_id: str, name: str, 
        ...
        async with self.db_pool.acquire() as conn:
            await conn.execute("""
                ...
                VALUES ($1, $2, $3, $4, $5)
            """, user_id, key_hash.decode('utf-8'), name, 
                permissions or [], expires_at)
    ...
    async def verify_api_key(self, api_key: str) -> Optional[Dict[str, Any]]:
        ...
        async with self.db_pool.acquire() as conn:
            ...
            for key_record in keys:
                if bcrypt.checkpw(api_key.encode('utf-8'), 
    ...
    async def create_session(self, user_id: str, token: str, 
        ...
        async with self.db_pool.acquire() as conn:
            session = await conn.fetchrow("""
                ...
                VALUES ($1, $2, $3, $4)
                RETURNING id
            """, user_id, token_hash.decode('utf-8'), device_info or {}, expires_at)
