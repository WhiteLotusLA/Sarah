...
class PermissionManager:
    ...
    async def _ensure_default_roles(self, conn: asyncpg.Connection) -> None:
        ...
        for role in Role:
            ...
            """,
                role.value,
                f"Default {role.value} role",
                [p.value for p in permissions],
            )

    async def grant_role(
        self, user_id: str, role: Union[Role, str], granted_by: str
    ) -> bool:
    ...
    async def revoke_permission(
        self, user_id: str, permission: Union[Permission, str], granted_by: str
    ) -> bool:
    ...
    async def check_any_permission(
        self, user_id: str, permissions: List[Union[Permission, str]]
    ) -> bool:
