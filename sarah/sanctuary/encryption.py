...
class Encryptor:
    ...
    def __init__(self, master_key: Optional[Union[str, bytes]] = None):
        ...
        if master_key:
            ...
            key = os.environ.get("SARAH_MASTER_KEY") or getattr(
            ...
            if key:
                ...
                logger.warning(
                    "Generated new master key - ensure this is stored securely!"
                )
    ...
    def encrypt_with_password(
        self, data: Union[str, bytes], password: str
    ) -> Dict[str, str]:
        """
    ...
    def decrypt_with_password(
        self, encrypted_data: str, salt: str, password: str
    ) -> str:
        """
    ...
    def decrypt_aes_gcm(
        self, ciphertext: str, nonce: str, associated_data: Optional[bytes] = None
    ) -> str:
        """
